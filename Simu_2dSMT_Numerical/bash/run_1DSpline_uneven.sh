...
nohup Rscript ../Simulation/Simu_1DSpline_uneven.R --mu_type ${Mu_t[$i]} --Cov_type ${Cov_t[$j]} --magnitude $mag --est_cov False >../logerr/Spline1Duneven$mag${Mu_t[$i]}${Cov_t[$j]}.out 2>../logerr/Spline1Duneven$mag${Mu_t[$i]}${Cov_t[$j]}.err
