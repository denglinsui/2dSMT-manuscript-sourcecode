...
source('Tools/DirectOptim/Likelihood2.R')
source('Tools/DirectOptim/CheckInput2.R')
source('Tools/DirectOptim/WlsInit2.R')
source('DirectOptim/InitParam2.R')
source('DirectOptim/loglik2.R')

FitComposite3 <- function (data, coordx, coordy = NULL, coordt = NULL, corrmodel, 
                           ...
                           winstp) {
  call <- match.call()
  checkinput <- CheckInput(coordx, coordy, coordt, corrmodel, 
                           data, distance, "Fitting", fixed, grid, likelihood, margins, 
                           maxdist, maxtime, model, NULL, optimizer, NULL, replicates, 
  ...
  initparam <- WlsInit(coordx, coordy, coordt, corrmodel, data, 
                       distance, "Fitting", fixed, grid, likelihood, margins, 
  ...
  if (likelihood == "Full") {
    fitted <- Likelihood(initparam$corrmodel, initparam$data, 
                         initparam$fixed, initparam$flagcorr, initparam$flagnuis, 
